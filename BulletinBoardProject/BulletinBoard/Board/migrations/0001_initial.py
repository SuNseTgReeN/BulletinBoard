    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.BooleanField(default=False, verbose_name='Status response')),
                ('responses_advertising', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Board.notification', verbose_name='Notification')),
